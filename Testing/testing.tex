...
% 33: Render item's category/aisle on shopping list ~\\
% 35: Render multiple items on shopping list ~\\
% 82: Allow user to store edited category/aisle in database and render on website ~\\
