...
X 31: Render item name on shopping list ~\\
X 76: Store item name in database and render on website ~\\
X 77: Store item categories in database and render on site ~\\
X 78: Store multiple items and render on website ~\\
...
\begin{enumerate}
	\item A category can be added and is stored in the database and can be retrieved and rendered correctly
\end{enumerate}
%%%%%%%%%%%%%%%%%%%%%%%%%5
